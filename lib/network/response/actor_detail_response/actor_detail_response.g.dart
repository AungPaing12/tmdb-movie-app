...
class ActorDetailResponseVOAdapter extends TypeAdapter<ActorDetailResponseVO> {
  @override
  final int typeId = 11;

  @override
  ActorDetailResponseVO read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return ActorDetailResponseVO(
  ...
  @override
  void write(BinaryWriter writer, ActorDetailResponseVO obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj.adult)
  ...
  bool operator ==(Object other) =>
      ...
      other is ActorDetailResponseVOAdapter &&
...
ActorDetailResponseVO _$ActorDetailResponseVOFromJson(
...
Map<String, dynamic> _$ActorDetailResponseVOToJson(
        ActorDetailResponseVO instance) =>
    <String, dynamic>{
